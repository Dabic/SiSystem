...
insert into APP_USER values ("securityFilter", "$2y$12$NyOf2b/Qm/i1ZyjFyCSIyuC7xyoLmN2hKmOkAOWKXNfRT8ScBBCMO");
...
insert into ROLES_FOR_USER values (6, "securityFilter", 3);
...
insert into PROVIDER values ("securityFilter", "security-filter.com", 8083);
